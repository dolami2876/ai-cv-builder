    ...
    <>
      <header className="sticky top-0 z-10 flex items-center justify-between border-b border-gray-200 bg-white/80 px-6 py-4 backdrop-blur-sm">
        <div className="flex flex-col">
          <Link href="/dashboard" className="mb-1 flex items-center gap-1 text-xs text-gray-500 hover:text-gray-900">
            <ArrowLeft className="h-3 w-3" /> Back
          </Link>
          <h1 className="text-xl font-bold tracking-tight text-gray-900">Resume Editor</h1>
        ...
        <div className="flex items-center gap-2">
          ...
          <ExportDropdown onDownloadPdf={handleDownload} onDownloadWord={handleDocxDownload} />

          <button
            onClick={() => setShowEvaluator(true)}
            className="group flex items-center gap-2 rounded-lg border border-purple-100 bg-purple-50 px-4 py-2 text-sm font-medium text-purple-700 transition-all hover:bg-purple-100 focus:outline-none focus:ring-2 focus:ring-purple-200"
          >
          ...
          <button
            ...
            className="group flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-700 transition-all hover:bg-gray-50 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-200"
          >
          ...
          <button
            ...
            disabled={isSaving}
            className="flex items-center gap-2 rounded-lg bg-gray-900 px-4 py-2 text-sm font-medium text-white shadow-sm transition-all hover:bg-gray-800 disabled:opacity-50"
          >
      ...
      <PricingModal isOpen={showPricing} onClose={() => setShowPricing(false)} clerkId={user?.id} />
